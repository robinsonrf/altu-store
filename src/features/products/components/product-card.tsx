...
export function ProductCard({ product, className }: ProductCardProps) {
  ...
  return (
    <article className={cn("group flex flex-col", className)}>
      <Link
        href={href}
        className="relative aspect-[4/5] w-full overflow-hidden bg-muted/70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-foreground/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
        <Image
          ...
          className="object-cover transition-[opacity,transform,filter] duration-[1200ms] ease-out motion-reduce:transition-none group-hover:opacity-[0.94] group-hover:scale-[1.014] group-hover:brightness-[1.015]"
        />
      </Link>

      <div className="flex flex-col gap-3 pt-9 sm:pt-10">
